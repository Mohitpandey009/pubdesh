            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="updateForm">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="revenue-share" name="share" placeholder="Enter the revenue in percentage">
                            </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" id="sendMessage" data-bs-dismiss="modal">Send message</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="main-header-logo">
                    ...
                    <div class="logo-header" data-background-color="dark">
                        <a href="index.html" class="logo">
                            <img src="<?php echo base_url('assets/img/kaiadmin/logo_light.svg')?>" alt="navbar brand" class="navbar-brand"
                                height="20" />
                        </a>
                                ...
                                <?php foreach($pendingapprove as $row): ?>
                                    <tr>
                                        ...
                                        <td style="display:flex; justify-content:space-evenly; flex-wrap:wrap;">
                                            ...
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"data-bs-target="#exampleModal" data-bs-whatever="@mdo" value='<?= $row->s_no?>'>Approved</button>

                                            <button type="button" class="btn btn-danger decline" value='<?= $row->s_no?>'>Decline</button>
