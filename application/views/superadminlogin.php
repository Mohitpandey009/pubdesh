...
<body>
    <nav class="topnav" id="topnav">
        <div class="maindiv">
            ...
            <button class="icon" onclick="toggle()"><img src="./assets/img/png-clipart-hamburger-button-computer-icons-marmon-keystone-canada-menu-red-sea-removebg-preview.png" alt=""></button>
        </div>
